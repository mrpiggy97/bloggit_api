"""
Django settings for bloggit_project project.
...
ALLOWED_CROSS_ORIGIN_HOST='http://localhost:8080'
...
JWT_AUTH = {
    ...
    'bloggit_project.utils.payload_handler.custom_payload_jwt_response_handler',
...
WSGI_APPLICATION = 'bloggit_project.wsgi.application'
